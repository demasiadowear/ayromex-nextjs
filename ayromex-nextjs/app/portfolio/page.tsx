...
export const metadata: Metadata = {
  ...
  description:
    'Guarda i lavori di AYROMEX: identita visive, social design, materiali stampa e presentazioni per attivita locali a Bari e in Puglia.',
}
...
const projects = [
  {
    ...
    desc: 'Identita visiva completa per un ristorante di pesce a Bari. Dal logo al menu, dalle insegne ai template social.',
  ...
  },
  {
    ...
    desc: 'Identita visiva e social design per una boutique di moda femminile. Look elegante e contemporaneo che rispecchia il posizionamento del brand.',
          ...
          {projects.map((p) => (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-5 gap-0">
                {/* Image placeholder */}
                <div
                  className={`md:col-span-2 aspect-[4/3] md:aspect-auto bg-gradient-to-br ${p.color} flex items-center justify-center min-h-[240px]`}
                >
                  <span className="text-white/20 text-sm font-display">
                    Immagine progetto
                  </span>
                </div>
      ...
      <section className="py-16 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-6xl px-5 text-center">
          ...
          <p className="mt-3 text-white/60 max-w-lg mx-auto">
            Raccontaci cosa hai in mente. Ti facciamo un preventivo gratuito
            entro 24 ore.
          </p>
          <Link
            href="/contatti"
